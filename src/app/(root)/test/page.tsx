...
import LocationPage from "@/components/discovery/LocationPage";
import NearbyUsers from "@/components/discovery/NearbyUsers";
...
export default async  function Page() {
  ...
  if(!session.userId) return {redirect:{destination:'/sign-in',permanent:false}};


  return (
    <div>
      {/* <LocationPage userId={session.userId} /> */}
      <NearbyUsers userId={session.userId} />
    </div>
  );
}